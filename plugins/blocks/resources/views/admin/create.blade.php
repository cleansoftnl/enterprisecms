...
@section('content')
    {!! Form::open(['class' => 'js-validate-form', 'url' => route('admin::blocks.create.post')]) !!}
    <div class="layout-2columns sidebar-right">
        <div class="column main">
            ...
            @php do_action('meta_boxes', 'main', 'blocks.create', $object) @endphp
        </div>
        <div class="column right">
            @php do_action('meta_boxes', 'top-sidebar', 'blocks.create', $object) @endphp
            @include('webed-core::admin._widgets.page-templates', [
                'name' => 'page_template',
                'templates' => get_templates('Block'),
                'selected' => isset($object) ? $object->page_template : '',
            ])
            @php do_action('meta_boxes', 'bottom-sidebar', 'blocks.create', $object) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
