...
@section('content')
    ...
    <div class="layout-2columns sidebar-right">
        <div class="column main">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', WEBED_RELATIONS_POSTS, $object) @endphp
        </div>
        <div class="column right">
            @include('webed-core::admin._components.form-actions')
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', WEBED_RELATIONS_POSTS, $object) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('relations::base.posts.form.tags') }}</h3>
                    <div class="box-tools">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse">
                            <i class="fa fa-minus"></i>
                        </button>
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', WEBED_RELATIONS_POSTS, $object) @endphp
        </div>
    </div>
    {!! Form::close() !!}
@endsection
