...
@section('content')
    ...
    <div class="layout-2columns sidebar-right">
        <div class="column main">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', WEBED_RELATIONS_TAGS, $object) @endphp
        </div>
        <div class="column right">
            @include('webed-core::admin._components.form-actions')
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', WEBED_RELATIONS_TAGS, null) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
