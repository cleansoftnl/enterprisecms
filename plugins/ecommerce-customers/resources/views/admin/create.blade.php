        ...
        <div class="column main">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs tab-change-url">
                    ...
                    @php do_action('tab_nav', 'ecommerce.customers.create') @endphp
                </ul>
                <div class="tab-content">
                    <div class="tab-pane {{ $curentTab === 'user_profiles' ? 'active' : '' }}" id="user_profiles">
                        {!! Form::open(['class' => 'js-validate-form', 'url' => route('admin::ecommerce.customers.create.post')]) !!}
                    ...
                    @php do_action('tab_content', 'ecommerce.customers.create') @endphp
                </div>
            </div>
        </div>
    </div>
