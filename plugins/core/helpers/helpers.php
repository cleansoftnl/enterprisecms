...
if (!function_exists('get_panel_type')) {
    /**
     * @return bool
     */
...
if (!function_exists('is_admin_panel')) {
    ...
    function is_admin_panel()
    {
        ...
        switch ($segment) {
            case config('webed.admin_route', 'admincp'):
                return true;
            break;
            /*case config('webed.system_route', 'systemcp'):
                return true;
            break;*/
            case config('webed.email_route', 'emailcp'):
                return true;
            break;

            case config('webed.calendar_route', 'calendarcp'):
                return true;
                break;
