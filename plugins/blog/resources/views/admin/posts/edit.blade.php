...
@section('content')
    ...
    <div class="layout-2columns sidebar-right">
        <div class="column main">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', WEBED_BLOG_POSTS, $object) @endphp
        </div>
        <div class="column right">
            @include('webed-core::admin._components.form-actions')
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', WEBED_BLOG_POSTS, $object) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', WEBED_BLOG_POSTS, $object) @endphp
        </div>
    </div>
    {!! Form::close() !!}
@endsection
